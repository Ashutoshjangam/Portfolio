...
const Index = () => {
  ...
  //         tags: ["React", "Expressjs", "HTML5", "Tailwind CSS"],
  //         delay: 100
  //       },
  //       {
                  ...
                  {cat.projects.map((project, idx) => (
                    ...
                    >
                      <div className="h-48 bg-gray-800 flex items-center justify-center">
                        <span className="text-portfolioPurple text-lg">Project Image</span>
                      </div>
                      <div className="p-6">
          ...
          <div className="max-w-3xl mx-auto bg-black/50 border border-portfolioPurple/30 rounded-lg p-8 flex flex-col md:flex-row items-center gap-8 about-animate opacity-0 translate-y-8 transition-all duration-1000">
            ...
            <div>
              <p className="text-gray-300 mb-4">
                I am Ashutosh Jangam, a passionate MERN stack developer with expertise in creating dynamic and responsive web applications. With a strong background in computer science, I specialize in building modern web solutions using MongoDB, Express.js, React, and Node.js.
              </p>
              <p className="text-gray-300 mb-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-200">contact@ashutoshjangam.com</p>
                    </div>
                  </div>
